...
' - Each Public Shared Property directly delegates Get/Set to the corresponding
'   member of _context; no transformation or validation is performed here.
' - This partial class groups only property exposure; other partial definitions
'   (not shown) may contain Add-in lifecycle or event logic.
' - Serves as a central static access point so other Excel Add-in code can read
'   and modify shared state (API credentials, model parameters, paths, feature
'   flags, prompt texts, OAuth2 data, search and library settings, markup
'   configuration, token and expiry data).
' =============================================================================
...
''' <summary>
''' Partial Excel Add-in class exposing shared configuration and state through Shared properties backed by a single ISharedContext instance.
''' </summary>
''' <remarks>
''' Each property delegates directly to the backing _context field without added logic.
''' </remarks>
