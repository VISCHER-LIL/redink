...
Partial Class Ribbon1
    ...
    "audio, image)"
        ...
        '
        'ModelsMenu
        ' NOTE: Due to VSTO Ribbon Designer limitations, we must declare all 10 model buttons upfront
        ' at design time. These buttons cannot be dynamically created at runtime because:
        ' 1. Ribbon controls must be declared in the Designer.vb file for proper event handling
        ' 2. The "WithEvents" keyword requires design-time declarations for automatic event wiring
        ' 3. Dynamic creation would require AddHandler instead of the cleaner Handles clause syntax
        ' The UpdateModelsMenu() method shows/hides these buttons and updates their labels based on
        ' available models from ModelConfigManager. Only configured models are made visible.
        '
